...
这份笔记前半部分是参考25年9月份Minimind的实现,现在26年5月MiniMind又做了一些升级,在此我们对项目中的代码进行了相应的更新,以适配Minimind项目本身的实现.

> New commit hash @9da8e1ab18ca0bbb3df9d8b5dbfbc8748810a5bf

这次参考 MiniMind 3 更新 `src` 中的实现时，我的感觉是：它不是只改了某一个小模块，而是把模型结构、数据组织、训练接口和工程稳定性一起往前推进了一步。
